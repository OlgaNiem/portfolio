...
function Geometries() {
    ...
    const materials = [
        new THREE.MeshNormalMaterial({roughness: 0.2, metalness: 0.7}),
        new THREE.MeshStandardMaterial({color: 0xEE5A24, roughness: 0.2, metalness: 0.5}),
        new THREE.MeshStandardMaterial({color: 0x1B1464, roughness: 0.4, metalness: 0.5}),
        new THREE.MeshStandardMaterial({color: 0xB53471, roughness: 0.2, metalness: 0.5}),
