...
type ContentListProps = {
  ...
  contentType: Content.ContentIndex2Slice["primary"]["content_type"];
  fallbackItemImage: Content.ContentIndex2Slice["primary"]["fallback_item_image"];
  viewMoreText: Content.ContentIndex2Slice["primary"]["view_more_text"];
}
              ...
              >
                ...
                >
                  <div className='flex flex-col'>
                    ...
                    <div className='flex gap-3 text-yellow-400 text-lg font-bold'>{item.tags.map((tag, index)=> (
