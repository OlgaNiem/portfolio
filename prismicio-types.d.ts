 ...
 */
export interface ContentIndex2SliceDefaultPrimary {
  /**
   * Heading field in *ContentIndex → Default → Primary*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: content_index2.default.primary.heading
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  heading: prismic.KeyTextField;
   ...
   * - **Field Type**: Select
   * - **Placeholder**: *None*
   * - **API ID Path**: content_index2.default.primary.content_type
   ...
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
   * - **API ID Path**: content_index2.default.primary.description
   * - **Documentation**: https://prismic.io/docs/field#rich-text-title
   */
  description: prismic.RichTextField;
   ...
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: content_index2.default.primary.view_more_text
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
   ...
   * - **Field Type**: Image
   * - **Placeholder**: *None*
   * - **API ID Path**: content_index2.default.primary.fallback_item_image
   * - **Documentation**: https://prismic.io/docs/field#image
   */
 ...
 * - **Documentation**: https://prismic.io/docs/slice
 */
export type ContentIndex2SliceDefault = prismic.SharedSliceVariation<
  "default",
  Simplify<ContentIndex2SliceDefaultPrimary>,
  never
>;
 ...
 */
type ContentIndex2SliceVariation = ContentIndex2SliceDefault;

/**
 * ContentIndex Shared Slice
 *
 * - **API ID**: `content_index2`
 * - **Description**: ContentIndex2
 * - **Documentation**: https://prismic.io/docs/slice
 */
export type ContentIndex2Slice = prismic.SharedSlice<
  "content_index2",
  ContentIndex2SliceVariation
>;

/**
 * Item in *Experience → Default → Primary → Education*
 */
export interface ExperienceSliceDefaultPrimaryEducationItem {
  /**
   * Title field in *Experience → Default → Primary → Education*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: experience.default.primary.education[].title
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  title: prismic.KeyTextField;

  /**
   * Time Period field in *Experience → Default → Primary → Education*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: experience.default.primary.education[].time_period
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  time_period: prismic.KeyTextField;

  /**
   * Institution field in *Experience → Default → Primary → Education*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: experience.default.primary.education[].institution
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  institution: prismic.KeyTextField;

  /**
   * Description field in *Experience → Default → Primary → Education*
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
   * - **API ID Path**: experience.default.primary.education[].description
   * - **Documentation**: https://prismic.io/docs/field#rich-text-title
   */
  description: prismic.RichTextField;
}
...
export interface ExperienceSliceDefaultPrimary {
  ...
  /**
   * Education field in *Experience → Default → Primary*
   *
   * - **Field Type**: Group
   * - **Placeholder**: *None*
   * - **API ID Path**: experience.default.primary.education[]
   * - **Documentation**: https://prismic.io/docs/field#group
   */
  education: prismic.GroupField<
    Simplify<ExperienceSliceDefaultPrimaryEducationItem>
  >;
}
...
declare module "@prismicio/client" {
  ...
  namespace Content {
    export type {
      ...
      ContentIndex2Slice,
      ContentIndex2SliceDefaultPrimary,
      ContentIndex2SliceVariation,
      ContentIndex2SliceDefault,
      ExperienceSlice,
      ExperienceSliceDefaultPrimaryEducationItem,
